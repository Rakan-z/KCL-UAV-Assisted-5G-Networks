...
This repository consists of files which include the thesis report and MATLAB program for my BEng Final Year Individual Project. Each file is described in the below sections.
