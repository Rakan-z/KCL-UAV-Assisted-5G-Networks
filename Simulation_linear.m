...
%Macro Base Stations based on the net distances of the two FBSs
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for node = 1:nodes_i                                                            
    ...
    for i = 1:montecarlo_i
        ...
        %calling function to run FBS_Boundary_search_lin algorithm to find the optimal linear edge at every instance i of the monte carlo simulation
