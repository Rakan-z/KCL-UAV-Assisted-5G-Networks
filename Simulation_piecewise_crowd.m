...
%two Macro Base Stations based on the location of the most optimal linear cell edge using the net distances of the two FBSs when there 
%is an overcrowding in one cell
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
seed1 = 0; %initializing seed which will be used to maintain the distribution of points throughout the instance i of the simulation
...
x_optimal_edge_lin = 1.95; %output of FBS_Boundary_search_lin: x coordinates of optimal linear boundary which will be altered for every set of nodes
...
for node = 1:nodes_i                                                            
    ...
    for i = 1:montecarlo_i
        ...
        %adjusting optimal linear boundary x coordinate per set of nodes accordingly
        if nodes == 20
            x_optimal_edge_lin = 1.95;
        elseif nodes == 30
            x_optimal_edge_lin = 1.5;
        elseif nodes == 40 
            x_optimal_edge_lin = 1.35;
        elseif nodes >= 50
            x_optimal_edge_lin = 1.2;
        end
...
%finding the mean net distance at each piecewise boundary of all instances of the monte carlo simulation for every set of nodes and the sd of the result
...
for bc1 = 1:length(dnet_mean_20nodes)
    ...
    set(gca,'xtick',1:25,'XTickLabel',{'1.8,1.8','1.8,1.875','1.8,1.95','1.8,2.025','1.8,2.1','1.875,1.8','1.875,1.875','1.875,1.95','1.875,2.025','1.875,2.1','1.95,1.8','1.95,1.875','1.95,1.95','1.95,2.025','1.95,2.1','2.025,1.8','2.025,1.875','2.025,1.95','2.025,2.025','2.025,2.1','2.1,1.8','2.1,1.875','2.1,1.95','2.1,2.025','2.1,2.1'})
    xtickangle(45)
end
hold off
...
for bc3 = 1:length(dnet_mean_40nodes)
    ...
    xlabel('Boundary x-coordinates of p2,p3 (km)')
    ylabel('Mean Net-Distance (km)') 
    set(gca,'xtick',1:25,'xticklabel',{'1.2,1.2','1.2,1.275','1.2,1.35','1.2,1.425','1.2,1.5','1.275,1.2','1.275,1.275','1.275,1.35','1.275,1.425','1.275,1.5','1.35,1.2','1.35,1.275','1.35,1.35','1.35,1.425','1.35,1.5','1.425,1.2','1.425,1.275','1.425,1.35','1.425,1.425','1.425,1.5','1.5,1.2','1.5,1.275','1.5,1.35','1.5,1.425','1.5,1.5'})
    xtickangle(45)
end
hold off 
...
for bc4 = 1:length(dnet_mean_50nodes)
    ...
    xlabel('Boundary x-coordinates of p2,p3 (km)')
    ylabel('Mean Net-Distance (km)') 
    set(gca,'xtick',1:25,'xticklabel',{'1.05,1.05','1.05,1.125','1.05,1.2','1.05,1.275','1.05,1.35','1.125,1.05','1.125,1.125','1.125,1.2','1.125,1.275','1.125,1.35','1.2,1.05','1.2,1.125','1.2,1.2','1.2,1.275','1.2,1.35','1.275,1.05','1.275,1.125','1.275,1.2','1.275,1.275','1.275,1.35','1.35,1.05','1.35,1.125','1.35,1.2','1.35,1.275','1.35,1.35'})
    xtickangle(45)
end
hold off
